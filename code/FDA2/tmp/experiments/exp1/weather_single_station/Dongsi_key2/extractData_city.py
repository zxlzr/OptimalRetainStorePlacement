...
#import math
#connect
c = "东四"    ###################### Need to change when changing station ######################
...
collection_weather = db_weather.Dongsi  ###################### Need to change when changing station ######################
...
ofile.append(codecs.open('station_Dongsi_tmp.txt', 'w',"utf-8"))
...
#write to file
    if(flag1==1 and result["pm2_5"]!=0.0 and result["n_pm2_5"]!=0.0):
