...
C_NAME_POI = 'shanghai_POIs_detail'
C_NAME_CHECKIN = 'shanghai_checkin'
STEP = 6
...
def get_checkin_data(ctype):
	result = []
	time_list = readtime('../events/shanghai_'+ctype+'_24h_150.txt')
	an_hour = datetime.timedelta(hours = 1)
	for t in time_list:
		t = t.strip('\r\n')
		log(t)
		#get start and end time
		end_time = datetime.datetime.strptime(t[0:19],ISOTIMEFORMAT)
