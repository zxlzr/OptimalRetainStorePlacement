...
d = loadData_tr(station, version, type1, type2);
...
Te = loadData_te(station, version, type1, type2);
Te = myNormalize(Te)
...
predict_record = zeros(size(Te,1),1)
for k = 1:REPEAT_NUM
...
%%%%% air  + mete + air_surround + mete_surround + traffic + checkin + om_range
    ...
    predict_record= predict_record+(label_Actual_whole-1)
end
...
function [d_te] = loadData_te(station, version, type1, type2)
    ...
    air_f1 = ['air/' station '_' type1 version '_te.txt'];
    air_f0 = ['air/' station '_' type2 version '_te.txt'];
    mete_f1 = ['mete/' station '_' type1 version '_te.txt'];
    mete_f0 = ['mete/' station '_' type2 version '_te.txt'];
    air_surround_f1 = ['air_surround/' station '_' type1 version '_te.txt'];
    air_surround_f0 = ['air_surround/' station '_' type2 version '_te.txt'];
    mete_surround_f1 = ['mete_surround/' station '_' type1 version '_te.txt'];
    mete_surround_f0 = ['mete_surround/' station '_' type2 version '_te.txt'];

    traffic_f1 = ['traffic_new/' station '_' type1 version '_te.txt'];
    traffic_f0 = ['traffic_new/' station '_' type2 version '_te.txt'];
    checkin_f1 = ['check-in/' station '_' type1 version '_te.txt'];
    checkin_f0 = ['check-in/' station '_' type2 version '_te.txt'];
    om_f1 = ['opinion_mining/' station '_' type1 version '_te.txt'];
    om_f0 = ['opinion_mining/' station '_' type2 version '_te.txt'];


    tmp_d = load(air_f1);
    d1_te = tmp_d(:,air_range);
    tmp_d = load(air_f0);
    d0_te = tmp_d(:,air_range);
    
    tmp_d = load(mete_f1);
    d1_te = [d1_te tmp_d(:,mete_range)];
    tmp_d = load(mete_f0);
    d0_te = [d0_te tmp_d(:,mete_range)];
   
    tmp_d = load(air_surround_f1);
    d1_te = [d1_te tmp_d(:,air_surround_range)];
    tmp_d = load(air_surround_f0);
    d0_te = [d0_te tmp_d(:,air_surround_range)];
    
    tmp_d = load(mete_surround_f1);
    d1_te = [d1_te tmp_d(:,mete_surround_range)];
    tmp_d = load(mete_surround_f0);
    d0_te = [d0_te tmp_d(:,mete_surround_range)];

    tmp_d = load(traffic_f1);
    d1_te = [d1_te tmp_d(:,traffic_range)];
    tmp_d = load(traffic_f0);
    d0_te = [d0_te tmp_d(:,traffic_range)];


    tmp_d = load(checkin_f1);
    d1_te = [d1_te tmp_d(:,checkin_range)];
    tmp_d = load(checkin_f0);
    d0_te = [d0_te tmp_d(:,checkin_range)];


    tmp_d = load(om_f1);
    d1_te = [d1_te tmp_d(:,om_range)];
    tmp_d = load(om_f0);
    d0_te = [d0_te tmp_d(:,om_range)];

    d1_te = [ones(size(d1_te,1),1) d1_te];
    d0_te = [zeros(size(d0_te,1),1) d0_te];
    d_te = [d1_te;d0_te];
    
end

function [d] = loadData_tr(station, version, type1, type2)
    ...
    air_f1 = ['air/' station '_' type1 version '_tr.txt'];
    air_f0 = ['air/' station '_' type2 version '_tr.txt'];
    mete_f1 = ['mete/' station '_' type1 version '_tr.txt'];
    mete_f0 = ['mete/' station '_' type2 version '_tr.txt'];
    air_surround_f1 = ['air_surround/' station '_' type1 version '_tr.txt'];
    air_surround_f0 = ['air_surround/' station '_' type2 version '_tr.txt'];
    mete_surround_f1 = ['mete_surround/' station '_' type1 version '_tr.txt'];
    mete_surround_f0 = ['mete_surround/' station '_' type2 version '_tr.txt'];

    traffic_f1 = ['traffic_new/' station '_' type1 version '_tr.txt'];
    traffic_f0 = ['traffic_new/' station '_' type2 version '_tr.txt'];
    checkin_f1 = ['check-in/' station '_' type1 version '_tr.txt'];
    checkin_f0 = ['check-in/' station '_' type2 version '_tr.txt'];
    om_f1 = ['opinion_mining/' station '_' type1 version '_tr.txt'];
    om_f0 = ['opinion_mining/' station '_' type2 version '_tr.txt'];
