...
ofile = []
ofile.append(codecs.open('station_Changping.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Changping_1.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Changping_2.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Changping_3.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Changping_4.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Changping_5.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Changping_6.txt', 'w',"utf-8"))
