...
ofile = []
ofile.append(codecs.open('station_Aotizhongxin.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Aotizhongxin_1.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Aotizhongxin_2.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Aotizhongxin_3.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Aotizhongxin_4.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Aotizhongxin_5.txt', 'w',"utf-8"))
ofile.append(codecs.open('station_Aotizhongxin_6.txt', 'w',"utf-8"))
